// TODO: Update or delete an expense for the current user. (PATCH).
// // TODO: Update or delete an expense for the current user. (DELETE).
...
export async function PATCH(req: Request, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    if (existingRes.rows.length === 0) return jsonError("Expense not found.", 404);
