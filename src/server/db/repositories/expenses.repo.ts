/**
 * TODO: Implement expense repository (CRUD, filtering, pagination) scoped by userId.
 */
...
export async function getExpenseById(input: { userId: string; id: string }) {
  const res = await db().execute({
...
export async function deleteExpense(input: { userId: string; id: string }) {
  await db().execute({
