...
// Keep this list in sync with src/server/db/migrations/*.sql
export const MIGRATIONS: Migration[] = [
  {
    id: "0001_init.sql",
    sql: `-- TODO: Initial migration to create all tables with user_id scoping and indexes.
...
`,
  ...
  {
    id: "0002_user_data_expiry.sql",
    sql: `-- Add per-user data expiry for automatic cleanup.
